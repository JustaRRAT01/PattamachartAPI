...
std=[
    {"id":1,"name":"MOSS","major":"T12","gpa":"3.25"},
    {"id":2,"name":"FLANK","major":"T12","gpa":"3.20"},
    {"id":3,"name":"JAMOL","major":"T12","gpa":"3.50"},
    {"id":4,"name":"CYCLE","major":"T12","gpa":"4.00"},
    {"id":5,"name":"PUB","major":"T12","gpa":"3.00"}
]
@app.route("/")
def Greet():
